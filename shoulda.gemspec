...
Gem::Specification.new do |s|
  ...
  required_files = [
    ...
    ['test', 'rails_root', '**', '*'],
    ['init.rb'],
  ].map { |path_arr| Dir.glob(File.join(File.dirname(__FILE__), *path_arr)) }.flatten
